...
export interface NotificacaoDoc { id: string; usuarioId: string; titulo: string; mensagem: string; lida: boolean; linkAcao?: string; tipo?: 'info' | 'sucesso' | 'alerta' | 'erro'; criadoEm?: string; }
...
with open('src/services/firebaseDatabase.ts', 'w') as f:
    f.write(content)
